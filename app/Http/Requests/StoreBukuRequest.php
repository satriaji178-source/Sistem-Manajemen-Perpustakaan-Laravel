...
class StoreBukuRequest extends FormRequest
{
    ...
    {
        // KodeBuku Baru: BK-XXX-000 (contoh: BK-PROG-001)
        return [
            ...
            'stok' => [
                ...
                function($attribute, $value, $fail) {
                    if ($this->input('tahun_terbit') < 2000 && $value > 5) {
                        $fail('Buku terbit sebelum tahun 2000, stok maksimal 5.');
                    }
                }
            ],
            ...
            'bahasa' => [
                ...
                function($attribute, $value, $fail) {
                    if ($this->input('kategori') === 'Programming' && strtolower($value) !== 'inggris') {
                        $fail('Jika kategori "Programming", harus menggunakan bahasa inggris.');
                    }
                }
            ],
        ];
